    ...
    public function run(): void
    {
        ...
        $products = [
            [
                ...
                'category_audio' => 'Điều Kỳ Diệu Của Tiệm Tạp Hóa Namiya - Higashino Keigo - VoizFM.mp3',
            ],
            [
            ...
            [
                ...
                'category_audio' => 'Việt Nam Sử Lược - Trần Trọng Kim - Trần Trọng Kim - VoizFM.mp3',
            ],
            [
                'category_name' => 'Tam quốc diễn nghĩa',
                'category_price' => 70000,
                'category_image' => 'tamquoc.jpg',
                'category_audio' => 'Sự Suy Tàn Của Quyền Lực - Moisés Naím - VoizFM.mp3',
            ],
            [
            ...
            [
                'category_name' => 'Đảo hoang',
                'category_price' => 50000,
                'category_image' => 'daohao.jpg',
                'category_audio' => 'Điều Kỳ Diệu Của Tiệm Tạp Hóa Namiya - Higashino Keigo - VoizFM.mp3',
            ],
            [
                'category_name' => 'Chị Đào Chị Lý',
                'category_price' => 70000,
                'category_image' => 'daoly.jpg',
                'category_audio' => 'Số Đỏ - Vũ Trọng Phụng - Vũ Trọng Phụng - VoizFM.mp3',
            ],
            [
                'category_name' => 'Con nhà giàu',
                'category_price' => 70000,
                'category_image' => 'giau.jpg',
                'category_audio' => 'Số Đỏ - Vũ Trọng Phụng - Vũ Trọng Phụng - VoizFM.mp3',
            ],
            [
                'category_name' => 'Tuổi trẻ dùng để làm gì?',
                'category_price' => 70000,
                'category_image' => 'tuoitre.jpg',
                'category_audio' => 'Thần Hổ - Tchya - Tchya - VoizFM.mp3',
            ],
            [
                'category_name' => 'Ngọc trong đá',
                'category_price' => 70000,
                'category_image' => 'nginda.jpg',
                'category_audio' => 'Số Đỏ - Vũ Trọng Phụng - Vũ Trọng Phụng - VoizFM.mp3',
            ],
            [
                'category_name' => 'Vô gia đình',
                'category_price' => 70000,
                'category_image' => 'vogiading.jpg',
                'category_audio' => 'Vô Gia Đình - Hector Malot - VoizFM.mp3',
            ],
            [
                'category_name' => 'Trúng số độc đắc',
                'category_price' => 70000,
                'category_image' => 'trungso.jpg',
                'category_audio' => 'Số Đỏ - Vũ Trọng Phụng - Vũ Trọng Phụng - VoizFM.mp3',
            ],
            [
                'category_name' => 'Vì nghĩa vì tình',
                'category_price' => 70000,
                'category_image' => 'nghiatinh.jpg',
                'category_audio' => 'Số Đỏ - Vũ Trọng Phụng - Vũ Trọng Phụng - VoizFM.mp3',
              ],
